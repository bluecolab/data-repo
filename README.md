...
## Stations
###  Locations
Please note that GPS locations are only available historically (a few years back) only for Ada, Alan, and Odin. 
#### Alan
type latitude          longitude
DD 41.1277363000700406-73.80833696495597
DMSN 41° 7' 39.851''   W 73° 48' 30.013''
#### Ada
type latitude          longitude
DD 41.1277363000700406-73.80833696495597
DMSN 41° 7' 39.851''   W 73° 48' 30.013''
...
DMS    N 41° 7' 37.269''    W 73° 48' 30.474''
## Sensors
...
| temperature | Air temperature | °C *(verify — PurpleAir's raw feed often reports °F)* | Air temperature at the sensor. |
| pressure | Barometric pressure | hPa | Atmospheric pressure at the sensor. |

**Notes**

- Ada and Alan's source system carries additional water-quality channels (pHmv, DOmgl, DOgain, Depth) that are **not** included in these flat-file exports; query the API directly if you need them.
...
- GPS coordinates (lat/lon) are available historically (a few years back) for Ada, Alan, and Odin only. For PurpleAir, ask Justin or query the PurpleAir API directly, and always specify which measurements and sensor IDs to request.
